...
var EventsIDToEvent = map[int32]EventConfig{
	...
	MountSetattEventID:            {ID: MountSetattEventID, ID32Bit: sys32mount_setattr, Name: "mount_setattr", Probes: []probe{{event: "mount_setattr", attach: sysCall, fn: "mount_setattr"}}, Sets: []string{"syscalls", "fs"}},
	QuotactlFdEventID:             {ID: QuotactlFdEventID, ID32Bit: sys32quotactl_fd, Name: "quotactl_fd", Probes: []probe{{event: "quotactl_fd", attach: sysCall, fn: "quotactl_fd"}}, Sets: []string{"syscalls", "fs"}},
	LandlockCreateRulesetEventID:  {ID: LandlockCreateRulesetEventID, ID32Bit: sys32landlock_create_ruleset, Name: "landlock_create_ruleset", Probes: []probe{{event: "landlock_create_ruleset", attach: sysCall, fn: "landlock_create_ruleset"}}, Sets: []string{"syscalls", "proc", "fs"}},
	LandlockAddRuleEventID:        {ID: LandlockAddRuleEventID, ID32Bit: sys32landlock_add_rule, Name: "landlock_add_rule", Probes: []probe{{event: "landlock_add_rule", attach: sysCall, fn: "landlock_add_rule"}}, Sets: []string{"syscalls", "proc", "fs"}},
	LandloclRestrictSetEventID:    {ID: LandloclRestrictSetEventID, ID32Bit: sys32landlock_restrict_self, Name: "landlock_restrict_self", Probes: []probe{{event: "landlock_restrict_self", attach: sysCall, fn: "landlock_restrict_self"}}, Sets: []string{"syscalls", "proc", "fs"}},
	MemfdSecretEventID:            {ID: MemfdSecretEventID, ID32Bit: sys32memfd_secret, Name: "memfd_secret", Probes: []probe{{event: "memfd_secret", attach: sysCall, fn: "memfd_secret"}}, Sets: []string{"syscalls"}},
	ProcessMreleaseEventID:        {ID: ProcessMreleaseEventID, ID32Bit: sys32process_mrelease, Name: "process_mrelease", Probes: []probe{{event: "process_mrelease", attach: sysCall, fn: "process_mrelease"}}, Sets: []string{"syscalls"}},
...
var EventsIDToParams = map[int32][]external.ArgMeta{
	...
	MountSetattEventID:            {{Type: "int", Name: "dfd"}, {Type: "char*", Name: "path"}, {Type: "unsigned int", Name: "flags"}, {Type: "struct mount_attr*", Name: "uattr"}, {Type: "size_t", Name: "usize"}},
	QuotactlFdEventID:             {{Type: "unsigned int", Name: "fd"}, {Type: "unsigned int", Name: "cmd"}, {Type: "qid_t", Name: "id"}, {Type: "void *", Name: "addr"}},
	LandlockCreateRulesetEventID:  {{Type: "struct landlock_ruleset_attr*", Name: "attr"}, {Type: "size_t", Name: "size"}, {Type: "u32", Name: "flags"}},
